...
#data ke 3 nama teman sebangku

print("Nama Teman Sebangku ke-3:", koleksi_nama_teman[2])

#tambahkan 1 data disetiap data koleksi

koleksi_nama_teman.append("Jamil Roblox")

print(koleksi_nama_teman)

#ubahlah Data Terakhir Nilai UTS

koleksi_data_int[-1] = "50"

print(koleksi_data_int)

#ubahlah data ke-3 nama hewan

koleksi_nama_hewan[2] = "onta"
